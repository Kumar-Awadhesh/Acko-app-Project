...
document.getElementById("claims").addEventListener("change", function(){
    //check if value is change then redirect to it's relevent page
    if(this.value){
        alert(`You do not have any ${this.value} to be claim !`);
    }
})

// getting the element by it's id and also adding event listener
document.getElementById("my_account").addEventListener("change", function(){
    //check if value is equal then show an alert message and redirect to it's relevent page
    if(this.value === "logout"){
        alert("Logout Successfully!");
        window.location.href = "index.html";
    }
    //check if value is equal then show an alert message
    else if(this.value === "my policies"){
        alert("You did not purchase any Policy yet!")
    }
})
